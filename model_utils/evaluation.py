...
import os, sys
from model_utils.utils import read_dataset
...
#    res_pred, res_gold = chain("./models/blstm_crf/test_results_epoch_5.tsv")
#    res_pred, res_gold = chain("./models/bert_crf/test_results_epoch_0.tsv")
#    precision_recall_f1(y_pred=res_pred, y_true=res_gold)
    pred_ids = ['1', '2', '0', '1', '2', '0', '0', '1', '2', '0', '1', '2', '2', '2']
    res = decode_ner(pred_ids)
    print("解码结果: ", res)
